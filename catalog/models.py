...
class Book(models.Model):
	...
	# Author as a string because Author class isn't declared yet.
	...
	def display_genre(self):
		"""Create a string for the genre. This is required for the admin site."""
		return ', '.join(genre.name for genre in self.genre.all()[:3])

	display_genre.short_description = 'Genre'

	def display_language(self):
		"""Create a string for the language. This is required by the admin site."""
